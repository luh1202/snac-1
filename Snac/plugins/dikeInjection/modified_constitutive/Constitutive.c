		 ...
		 if (global_K_range==1){
		   ...
		   */
           ...
           double M =  pow( (ijk[2]+0.0f) / ( global_K_range + 0.0f), 0.333333 ) * (Me - Mb) + Mb;
             ...
             //In input file, Mb and Me must be set as 0.5 to achive the designed function, which M is change within 0.3 to 0.7
             //period 2Ma
            if( M_type == 5 ){
            double M = ((ijk[2]+0.0f) / ( global_K_range + 0.0f) * (Me - Mb) + Mb)*sin(((2*PI)/(6.3072e+13))*(self->currentTime))+0.2;
             (*stress)[0][0] -= (material->lambda + 2.0f * material->mu) * epsilon_xx * M;
             (*stress)[1][1] -= material->lambda * epsilon_xx * M;
             (*stress)[2][2] -= material->lambda * epsilon_xx * M;
                         //fprintf(stderr, " M_type=%f\n global_K_range=%d\n ijk[2]=%d\n, M = %f\n \n \n",  M_type, global_K_range, ijk[2], M);
             ...
             //period 1Ma
             if( M_type == 6 ){
             double M = M = ((ijk[2]+0.0f) / ( global_K_range + 0.0f) * (Me - Mb) + Mb)*sin(((2*PI)/(3.1536e+13))*(self->currentTime))+0.2;
                ...
                //period 0.5Ma
             if( M_type == 7 ){
                 double M = ((ijk[2]+0.0f) / ( global_K_range + 0.0f) * (Me - Mb) + Mb)*sin(((2*PI)/(1.5768e+13))*(self->currentTime))+0.2;
                 ...
                 //period 0.25Ma
             if( M_type == 8 ){
                 double M = ((ijk[2]+0.0f) / ( global_K_range + 0.0f) * (Me - Mb) + Mb)*sin(((2*PI)/(7.884e+12))*(self->currentTime))+0.2;
             ...
             //period 0.1Ma
             if( M_type == 9 ){
                 double M = ((ijk[2]+0.0f) / ( global_K_range + 0.0f) * (Me - Mb) + Mb)*sin(((2*PI)/(3.942e+12))*(self->currentTime))+0.2;
            ...
            //period 0.05Ma
             if( M_type == 10 ){
                 double M = ((ijk[2]+0.0f) / ( global_K_range + 0.0f) * (Me - Mb) + Mb)*sin(((2*PI)/(1.971e+12))*(self->currentTime))+0.2;
             ...
             //period 0.01Ma
             if( M_type == 11 ){
                 double M = ((ijk[2]+0.0f) / ( global_K_range + 0.0f) * (Me - Mb) + Mb)*sin(((2*PI)/(3.942e+11))*(self->currentTime))+0.2;
             ...
             //period 0.005Ma
             if( M_type == 12 ){
                 double M = ((ijk[2]+0.0f) / ( global_K_range + 0.0f) * (Me - Mb) + Mb)*sin(((2*PI)/(1.971e+11))*(self->currentTime))+0.2;
